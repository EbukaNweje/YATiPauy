      ...
      <div className="wrapper">
        <div className="HeroPageleft">
          ...
          <p className="animate__animated animate__fadeInLeft">
            YATiCare Is A Powerful Community-Driven Financial Model, <br />{" "}
            birthed for the purpose of Creating Connections and Enhancing
            Financial Growth amongst <br /> Individuals and Businesses.
          </p>
