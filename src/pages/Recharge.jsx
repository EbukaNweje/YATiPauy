  ...
  return (
    <div className='Recharge'>
      ...
      <div className='paymentWarnings'>
        <li>1. Minimum Recharge amount ₦3,000.00. If payment is less than ₦3,000.00, the amount will not be reflected.</li>
        <li>2. Maximum Recharge amount ₦1,000,000.00. If payment is greater than ₦1,000,000.00, the amount will not be processed.</li>
        <li>3. Recharge can only be done inside the payment channels onYATipauy platform.</li>
        ...
        <li>6. If the amount is not reflected after 10 minutes, send the payment voucher toYATipauy customer service for help. Do not disclose your payment receipt to prevent others from stealing it.</li>
