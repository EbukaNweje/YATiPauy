...
const Terms = () => {
  return (
    <div className="Terms">
      <h3>YATiCare Terms and Conditions</h3>
      <h4 className="last-updated">Last Updated: 1st April 2026</h4>
      ...
      <ol>
        <li>
          ...
          <p>
            YATiCare is a peer-to-peer financial platform that enables
            individuals and businesses to contribute money to each other while
            earning returns. We promote financial empowerment, transparency, and
        ...
        <li>
          ...
          <p>
            If you suspect fraudulent activity on your account, contact{" "}
        ...
        <li>
          ...
          <ul>
            <li>
              Every member with an active subscription is entitled to{" "}
              <strong>20% daily income</strong> (inclusive of capital and
              profit).
            </li>
            <li>
              Over a 6‑day cycle, this amounts to a total of{" "}
              <strong>120%</strong> (100% capital recovery plus 20% net profit).
            </li>
            <li>
          ...
          <ul>
            <li>
              The minimum withdrawable amount is <strong>$50 USD</strong>.
            </li>
            <li>
        ...
        <li>
          <h4>
            5. Account Liquidation (Full Withdrawal Without Active Subscription)
          </h4>
          <p>
          ...
          <ul>
            <li>
              ...
              <strong>"Account Liquidation Notice"</strong>.
            </li>
            <li>
            ...
            <li>
              After the 3‑month notice period, your liquidation request will be
              honored, and any applicable fees will be processed at that time.
            </li>
          </ul>
          <p>
            Failure to provide a 3‑month notice will result in your liquidation
            request being denied. This policy ensures orderly management of
            community funds and protects the interests of all members.
          </p>
        </li>

        <li>
          <h4>6. Prohibited Activities & Fraudulent Manipulation</h4>
          <p>
          ...
          <ul>
            <li>
              <strong>Manipulation of daily returns</strong> – Any activity that
              results in earning more than the prescribed 20% daily (e.g., 40%,
              60%, or 100% in a single day) is considered a violation.
            </li>
            <li>
          ...
          <p>
            ...
            given day through manipulation or malicious activity:
          </p>
          <ul>
        ...
        <li>
          <h4>7. Fees & Charges</h4>
          <ul>
            <li>
              YATiCare charges a <strong>15% withdrawal fee</strong> (10%
              Australian GST + 5% Community Empowerment Fee).
            </li>
            <li>
        ...
        <li>
          <h4>10. User Conduct & Prohibited Activities (General)</h4>
          ...
          <ul>
            ...
            <li>
              Violate the specific subscription, withdrawal, or liquidation
              rules outlined in Sections 4, 5, and 6.
            </li>
          </ul>
          <p>
        ...
        <li>
          <h4>14. Amendments to These Terms</h4>
          <ul>
            <li>
            ...
            <li>
              ...
              or platform announcements, as it will be clearly visible under the
      ...
      <p className="agreement">
        ...
        as last updated on <strong>1st April 2026</strong>.
      </p>
    </div>
  );
};
