  ...
  return (
    <div className="Terms">
      ...
      <span>
        ...
        YATiCare' platform, services, and financial programs. By using our
      ...
      <ol>
        ...
        <li>
          2. Eligibility
          <h4>To use YATiCare, you must: </h4>
          <span>
        ...
        <li>
          ...
          <p>
            ...
            [YATihelpdesk@gmail.com] immediately.{" "}
          </p>
        </li>
        ...
        <li>
          ...
          <h4>
            YATiCare offers various peer-to-peer financial models, including:{" "}
          </h4>
          <span>
            ✔ Savings Pools– Users contribute funds and receive returns based on
            predefined cycles.{" "}
          </span>
          <span>
            ✔ Lending Circles – Members provide short-term financial support to
            each other.{" "}
          </span>
          <span>
            ✔ Crowdfunding & Community Support – Users can contribute to
            financial goals or businesses.{" "}
          </span>
          <h4 className="margin">📌 Important Notes: </h4>
          <span>
            - Contributions are voluntary, and participants must understand the
            associated risks.
          </span>
          <span>
            - Returns are based on community contributions and not guaranteed in
            fixed amounts.{" "}
          </span>
          <span>
            - YATiCare reserves the right to adjust contribution models to
        ...
        <li>
          5. Fees & Charges
          <span>
            ✅ YATiCare may charge transaction fees, service fees, or withdrawal
            fees, which will be clearly stated on the platform.{" "}
          </span>
          <span>
            ✅ All applicable fees will be communicated upfront before
            transactions.{" "}
          </span>
          <span>
        ...
        <li>
          ...
          <span>
            ✔ Returns may fluctuate based on community participation.{" "}
          </span>
          <span>
        ...
        <li>
          ...
          <span>
            ❌ Exploit or manipulate the system for unfair financial gain.{" "}
          </span>
          <p>
        ...
        <li>
          ...
          <span>✔ Attempt resolution through YATiCare customer support. </span>
          <span>
            ✔ Submit complaints in writing before taking any external action.{" "}
          </span>
          <span>
            ✔ Accept that YATiCare' decision is final in cases where platform
            policies apply.{" "}
          </span>
        </li>
        ...
        <li>
          ...
          <span>
            📌 YATiCare reserves the right to update or modify these Terms at
            any time.{" "}
          </span>
          <span>
        ...
        <li>
          13. Contact Us For inquiries, complaints, or support, reach out to:
