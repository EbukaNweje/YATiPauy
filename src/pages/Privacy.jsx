    ...
    <div className="Privacy">
      ...
      <ol>
        <li>
          ...
          <span>
            ✔ Date of birth, nationality, and government-issued identification
            (for verification).{" "}
          </span>
          <span>
          ...
          <span>
            ✔ Usage data, such as login activity, page views, and transaction
            history.{" "}
          </span>
          <span>
          ...
          <span>
            ✔ Data from partners, financial institutions, or identity
            verification services.{" "}
          </span>
          <span>
            ✔ Publicly available information related to fraud prevention and
            security.{" "}
          </span>
        </li>
        ...
        <li>
          ...
          <span>
            ✅ Send important updates, promotions, or service-related
            notifications.{" "}
          </span>
        ...
        <li>
          ...
          <span>
            ✔ Data Encryption – All sensitive data is encrypted to prevent
            unauthorized access.{" "}
          </span>
          <span>
            ✔ Access Controls – Only authorized personnel have access to user
            information.{" "}
          </span>
          <span>
            ✔ Regular Security Audits – We continuously monitor for threats and
            vulnerabilities.{" "}
          </span>
          <p>
        ...
        <li>
          ...
          <span>
            🔹 In cases where users voluntarily engage with financial partners
            or affiliated services.{" "}
          </span>
          <p>
            We will never share your personal data without your consent, except
        ...
        <li>
          ...
          <span>
            🍪 Analyze traffic and trends for better service optimization.{" "}
          </span>
          <p>
            Users can disable cookies in their browser settings, but doing so
        ...
        <li>
          ...
          <span>
            ✔ Edit or Correct Information – Update inaccurate details in your
            account.{" "}
          </span>
          <span>
            ✔ Request Data Deletion – Ask for the removal of your personal data
            (subject to legal obligations).{" "}
          </span>
          <span>
            ✔ Opt-Out of Marketing – Unsubscribe from promotional emails or
            messages.{" "}
          </span>
          <p>
        ...
        <li>
          7. Data Retention
          <span>
            📌 We retain user information only as long as necessary for legal,
            operational, or security purposes.{" "}
          </span>
          <span>
            📌 If an account is closed, we may retain limited data to comply
            with regulations or prevent fraud.{" "}
          </span>
        </li>
        ...
        <li>
          ...
          <span>
            ✔ We ensure compliance with international data protection laws.{" "}
          </span>
          <span>
            ✔ Users in the EU, UK, Canada, and other regions have additional
            data protection rights under GDPR and other regulations.{" "}
          </span>
          ---
        </li>
